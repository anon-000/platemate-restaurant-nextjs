...
import {TableService} from "../../src/apis/rest.app";
import {
    Box,
    Button,
    CircularProgress,
...
import RestaurantTableRow from "../../src/page-components/tables/RestaurantTableRow";
                ...
                <Box mt={2}>
                    ...
                    >
                        <Box sx={{
                            ...
                            <Grid container>
                                {/*<Grid item xs={4}>*/}
                                {/*    <Typography variant='body2' color={'#403D26'} fontWeight={600}>{'Table Id'}</Typography>*/}
                                {/*</Grid>*/}
                                <Grid item xs={3.5}>
                                    <Typography variant='body2' color={'#403D26'}
                                                fontWeight={600}>{'Table No.'}</Typography>
                                </Grid>
                                <Grid item xs={3.5}>
                                    <Typography variant='body2' color={'#403D26'}
                                                fontWeight={600}>{'No. of seats'}</Typography>
                                </Grid>
                                <Grid item xs={4}>
                                    <Typography variant='body2' color={'#403D26'}
