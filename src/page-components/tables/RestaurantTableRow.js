...
const RestaurantTableRow = ({each, index, setAllServices, allServices, setIndex, setEach, setOpen}) => {
    ...
    return (
        <>
            <Box mt={2} sx={{
                ...
                <Grid container>
                    {/*<Grid item xs={4}>*/}
                    {/*    <Typography variant='body2'>{each._id}</Typography>*/}
                    {/*</Grid>*/}
                    <Grid item xs={3.5}>
                        <Typography variant='body2'>{each?.tableNumber}</Typography>
                    </Grid>
                    <Grid item xs={3.5}>
                        <Typography variant='body2' sx={{wordBreak: 'break-all'}}>{each?.seatsCount}</Typography>
                    </Grid>
                    <Grid item xs={4}>
